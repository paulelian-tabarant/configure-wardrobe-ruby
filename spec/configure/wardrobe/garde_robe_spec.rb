...
RSpec.describe GardeRobe do
  ...
  it "donne les combinaisons de n fois un élément et 1 fois un autre" do
    # étant donné
    @garde_robe = GardeRobe.new(1000)
  ...
  context "acceptance" do
    it "donne la solution du problème" do
      # étant donné
      elements = [50, 75, 100, 120]
      attendu = [
        Combinaison.new([50, 50, 50, 50, 50]),
        Combinaison.new([50, 50, 75, 75]),
        Combinaison.new([50, 100, 100]),
        Combinaison.new([50, 50, 50, 100]),
        Combinaison.new([75, 75, 100])
      ]

      # quand
      combinaisons = @garde_robe.combinaisons(elements)
